        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {onToggleMobileMenu && (
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all shadow-xs"
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
          ...
          {onOpenSubjectModal && (
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs font-bold transition-all shadow-xs cursor-pointer"
            ...
            >
              ...
              <span className={`text-[10px] px-1.5 py-0.2 rounded-full font-extrabold ${
                ...
                {subjects && subjects.length > 0 ? subjects.length : "+ Set"}
              </span>
            </button>
          )}
          ...
          {(() => {
              ...
              return (
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    id="nav-login-btn"
                    onClick={handleOpenAuth}
                    className="flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-bold text-xs sm:text-sm shadow-md shadow-indigo-600/20 transition-all cursor-pointer select-none shrink-0"
            ...
            return (
              <button
                ...
                onClick={handleOpenAuth}
                className="flex items-center gap-2 pl-1.5 pr-3 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-900/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/60 transition-all cursor-pointer shadow-xs select-none shrink-0 group"
              ...
              >
                ...
                <div className="flex flex-col text-left pr-0.5">
                  <span className="font-extrabold text-xs text-indigo-950 dark:text-indigo-200 truncate max-w-[110px]">
                    {firstName}
                  </span>
